...
STDMETHODIMP  CCorProfilerCallbackImpl::InitializeForAttach( 
...
STDMETHODIMP CCorProfilerCallbackImpl::ProfilerAttachComplete( void)
{
	return S_OK;
}
        
STDMETHODIMP CCorProfilerCallbackImpl::ProfilerDetachSucceeded( void)
{
	return S_OK;
}
